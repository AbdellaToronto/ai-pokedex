...
import {
  generalizedAIPoweredPokemonQuery,
  generatePokemonBadge,
  streamAIAnalysis,
} from "@/server/actions/pokemon-ai";
...
export function PokemonComponent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const generatedBadgeData = await generatePokemonBadge(
        fullAnalysis,
        result.rows
      );
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex bg-white rounded-lg shadow-lg p-3 md:p-6 border-4 border-blue-500 max-h-[100px] md:max-h-[200px]">
          <h2 className="text-xl md:text-2xl font-bold text-center mb-2 md:mb-4 text-blue-600 z-50">
            AI Pokédex
          </h2>
        ...
        >
          <AnimatePresence mode="wait">
            {isLoading ? (
              ...
              >
                Ask a question about a Pokémon! Be as in depth and technical as
                possible!
              </motion.p>
            )}
          </AnimatePresence>
